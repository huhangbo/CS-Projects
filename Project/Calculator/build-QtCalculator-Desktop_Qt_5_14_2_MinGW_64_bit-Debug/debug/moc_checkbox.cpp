...
#include <memory>
#include "../../Qt-Calculator-master/checkbox.h"
...
QT_MOC_LITERAL(1, 9, 14), // "checkBoxChange"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "flag"
QT_MOC_LITERAL(4, 30, 9) // "showTitle"

    },
    "Checkbox\0checkBoxChange\0\0flag\0showTitle"
};
...
void Checkbox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkBoxChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->showTitle((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Checkbox::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Checkbox::checkBoxChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Checkbox::checkBoxChange(int _t1)
{
