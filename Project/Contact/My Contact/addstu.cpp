...
void AddStu::on_PartBox_activated(QString s)
{
    ...
    if (s==QString("计算机学院") )
    {
        ...
        ui->ClassBox->addItem("信安2班",22);
        ui->ClassBox->addItem("信安3班",23);
        ui->ClassBox->addItem("信安4班",24);
        ui->ClassBox->addItem("大数据1班",31);
        ui->ClassBox->addItem("大数据2班",32);
    }
    if (s==QString("电力学院"))
    {
        ui->ClassBox->clear();
        ui->ClassBox->addItem("电气1班",11);
        ui->ClassBox->addItem("电气2班",12);
        ui->ClassBox->addItem("电气3班",13);
        ui->ClassBox->addItem("电气4班",14);
        ui->ClassBox->addItem("能动1班",21);
        ui->ClassBox->addItem("能动2班",22);
    }
    if (s==QString("信控学院"))
    {
        ui->ClassBox->clear();
        ui->ClassBox->addItem("自动化1班",11);
        ui->ClassBox->addItem("自动化2班",12);
        ui->ClassBox->addItem("电信1班",21);
        ui->ClassBox->addItem("电信2班",22);
        ui->ClassBox->addItem("通信1班",31);
    }
    if (s==QString("安全学院"))
    {
        ui->ClassBox->clear();
        ui->ClassBox->addItem("矿山1班",11);
        ui->ClassBox->addItem("矿山2班",12);
        ui->ClassBox->addItem("消防1班",21);
        ui->ClassBox->addItem("消防2班",22);
    }
    if (s==QString("化工学院"))
    {
        ui->ClassBox->clear();
        ui->ClassBox->addItem("应化1班",11);
        ui->ClassBox->addItem("应化2班",12);
        ui->ClassBox->addItem("生工1班",21);
        ui->ClassBox->addItem("生工2班",22);
    }
}
