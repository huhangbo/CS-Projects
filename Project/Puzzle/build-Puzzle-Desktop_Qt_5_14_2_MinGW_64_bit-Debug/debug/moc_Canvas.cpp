...
#include <memory>
#include "../../PuzzlePool-1aa7669c505cd52e1ede926bb38461fd26145c43/include/Canvas/Canvas.h"
...
QT_MOC_LITERAL(1, 7, 12), // "resizeParent"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "size"

    },
    "Canvas\0resizeParent\0\0size"
};
...
static const uint qt_meta_data_Canvas[] = {
 ...
 // signals: parameters
    QMetaType::Int, QMetaType::QSize,    3,
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->resizeParent((*reinterpret_cast< QSize(*)>(_a[1])));
        ...
        {
            using _t = int (Canvas::*)(QSize );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::resizeParent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int Canvas::resizeParent(QSize _t1)
{
    int _t0{};
