...
#include <memory>
#include "../../PuzzlePool-1aa7669c505cd52e1ede926bb38461fd26145c43/listdialog.h"
...
QT_MOC_LITERAL(3, 26, 9) // "fileName_"

    },
    "ListDialog\0onItemChanged\0\0fileName_"
};
...
void ListDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ListDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onItemChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
